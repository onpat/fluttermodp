...
Future<String> _initializeOpenMpt() async {
  if (!Platform.isAndroid) {
    return 'libopenmpt initialization is skipped outside Android.';
  }
...
Future<void> main() async {
  ...
  final initializationMessage = await _initializeOpenMpt();
  runApp(FlutterModp(initializationMessage: initializationMessage));
}
